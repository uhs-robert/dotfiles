...
Item {
    ...
    // hearts, pixel (stepped, integer motion), lcd (pixel-styled, then the glyph blinks twice at the end) or fanfare.
    ...
    Repeater {
        model: root.fanfare ? [] : root.nudge ? [{ dx: 0, delay: 100 }] : [{ dx: -3, delay: 120 }, { dx: 3, delay: 260 }, { dx: 0, delay: 400 }]
    ...
    Text {
        ...
        scale: root.fanfare ? 1 : root.pop_scale
