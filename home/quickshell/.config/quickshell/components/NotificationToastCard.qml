...
Rectangle {
    ...
    color: Style.frame_visor || Style.frame_cut > 0 ? "transparent" : Style.boxed_cards
    ...
    border.width: Style.frame_visor || Style.frame_cut > 0 ? 0 : root.selected && !Style.boxed_cards ? 2 : 1
    ...
    FrameShade {
        visible: Style.boxed_cards && Style.frame_shade.a > 0 && Style.frame_cut <= 0
        anchors.fill: parent
