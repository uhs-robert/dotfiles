...
Rectangle {
    ...
    color: root.cut ? "transparent" : root.active ? Theme.theme_primary : mouse_area.pressed ? Qt.darker(Theme.bg_surface, 1.3) : mouse_area.containsMouse ? Theme.ui_visual_bg : Theme.bg_surface
