...
Row {
    ...
    Text {
        ...
        font.pixelSize: Style.bar_clock_size || Theme.glyph_size
    }
    ...
    Rectangle {
        ...
        Text {
            ...
            font.pixelSize: root.lualine ? Style.bar_clock_size || Theme.glyph_size : root.chip ? Style.bar_font_size + 2 : Style.bar_font_size
