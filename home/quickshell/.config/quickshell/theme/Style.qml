...
Singleton {
    ...
    // Alternate layouts: "" keeps the default; osd "ring" or "readout", weather "ring", "spec", "scope", "watch", "memcard", "battle", "mode7", "wttr", "weatherstar", "towers", "scan" or "pokedex", cards "rule", "channel" or "pixel".
    ...
    // The keeptabs done celebration: hearts, pixel (stepped), lcd (stepped, then blinks) or levelup (inverted flash, pixel sparkles).
    readonly property string done_anim: root.active.done_anim || "hearts"
    // The keeptabs waiting cue: bubble, cursor, pressanykey, advance, hand, alert, rumble, transmission, scan, comms, ping, orders or exclaim.
