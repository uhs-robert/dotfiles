...
Bind.leader_cmd("SHIFT + RETURN",   MENU .. " -i -show run",      "Run Script")
Bind.leader_cmd("CTRL + RETURN",    MENU .. " -i -show ssh",      "SSH Select")
Bind.leader_cmd("E",                FILES,                        "File Manager")
Bind.leader_cmd("SHIFT + E",        TERM .. " -e " .. TUI_FILES,  "TUI File Manager")
Bind.leader_cmd("O",                MENU .. " -i -show drun",     "Open Application")
