...
SETUPS["🛠 Config"]="1:flatpak run eu.betterbird.Betterbird|2:firefox|3:firefox|4:kitty -e tmuxifier load-session config"
...
SETUPS["💼 Work"]="1:flatpak run eu.betterbird.Betterbird|2:firefox|3:firefox|4:kitty -e tmuxifier load-session uphill|5:slack"
